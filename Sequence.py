"""my code defines the longest first possible sequence
of same letters for each from two strings

create function which makes list of characters
encountered in both strings, except spaces"""
